...
import 'package:dress_up/screen/product_detail_screen/glasses_detail_screen.dart';
...
class _GlassesScreenState extends State<GlassesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
            child: widget.productsModel.glasses![0].image != null
                ? ListView.builder(
