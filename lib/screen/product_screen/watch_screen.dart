...
import 'package:dress_up/screen/product_detail_screen/watch_detail_screen.dart';
...
class _WatchScreenState extends State<WatchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
            child: widget.productsModel.watch![0].image != null
                ? ListView.builder(
                    itemCount: widget.productsModel.watch!.length,
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              customText(
                                  widget.productsModel.watch![index].name
                                      .toString(),
                                  30,
                              ...
                              Row(
                                ...
                                children: [
                                  customImage(
                                      widget.productsModel.watch![index].image
                                          .toString(),
                                      widget.height * 0.5,
                                      widget.width * 0.7),
                                  customText(
                                      "RS ${widget.productsModel.watch![index].price.toString()}",
                                      15,
