...
import 'package:dress_up/screen/product_detail_screen/pant_detail_screen.dart';
...
class _PantScreenState extends State<PantScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
            child: widget.productsModel.pant![0].image != null
                ? ListView.builder(
                    itemCount: widget.productsModel.pant!.length,
