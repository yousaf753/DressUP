...
import 'package:dress_up/screen/product_detail_screen/coat_pant_detail_screen.dart';
...
class CoatPantScreen extends StatefulWidget {
  ...
  @override
  _CoatPantScreenState createState() => _CoatPantScreenState();
}

class _CoatPantScreenState extends State<CoatPantScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
            child: widget.productsModel.coatpant![0].image != null
                ? ListView.builder(
                    itemCount: widget.productsModel.coatpant!.length,
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  customImage(
                                      widget
                                          .productsModel.coatpant![index].image
                                          .toString(),
                                      widget.height * 0.5,
                                      widget.width * 0.7),
                                  customText(
