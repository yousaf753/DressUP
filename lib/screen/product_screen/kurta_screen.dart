...
import 'package:dress_up/screen/product_detail_screen/kurta_detail_screen.dart';
...
class _KurtaScreenState extends State<KurtaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
            child: widget.productsModel.kurta![0].image != null
                ? ListView.builder(
                    itemCount: widget.productsModel.kurta!.length,
