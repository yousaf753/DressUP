...
class Offer4Screen extends StatefulWidget {
  ...
  @override
  _Offer4ScreenState createState() => _Offer4ScreenState();
}

class _Offer4ScreenState extends State<Offer4Screen> {
      ...
      body: SafeArea(
        ...
        child: SizedBox(
          ...
          child: ListView.builder(
              ...
              itemCount: widget.productsModel.glasses!.length,
                          ...
                          children: [
                            Expanded(
                                ...
                                child: Padding(
                                    ...
                                    child: customText(
                                        widget
                                            .productsModel.glasses![index].name
                                            .toString(),
                                        30,
                            ...
                            Expanded(
                                ...
                                child: Padding(
                                    ...
                                    child: customImage(
                                        widget
                                            .productsModel.glasses![index].image
                                            .toString(),
                                        widget.height * 0.3,
                                        widget.width * 0.3)))
                          ],
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                customText(
                                    "RS ${widget.productsModel.glasses![index].price.toString()}",
                                    15,
                            ...
                            Column(
                              children: [
                                customText("New Price", 15,
                                    AppColors.text3Color, FontWeight.bold),
                                customText(
                                    "RS ${persentagae(widget.productsModel.glasses![index].price.toString(), 0.4)}",
                                    15,
                                    AppColors.text2Color,
                                    FontWeight.bold),
                              ],
                          ...
                          child: InkWell(
                            onTap: () {
                              cartController.addItem(
                                  widget.productsModel.glasses![index].name
                                      .toString(),
                                  widget.productsModel.glasses![index].image
                                      .toString(),
                                  double.parse(persentagae(
                                      widget.productsModel.glasses![index].price
                                          .toString(),
                                      0.4)),
                                  widget
                                      .productsModel.glasses![index].description
                                      .toString(),
                                  1);
                              Get.off(CartScreen(
