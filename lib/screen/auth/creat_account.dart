import 'package:dress_up/authentication/email_sign_in.dart';
                ...
                InkWell(
                  onTap: () async {
                    if (await sendOtp(_emailController.text)) {
                      Get.snackbar("OTP Send", "check your mail");
                    } else {
                      Get.snackbar("Wrong Email", "Pleas enter Correct mail");
                    }
                  },
                  child: Container(
                    height: 30,
                    ...
                    child: Center(
                        child: customText("Verify Email", 20,
                      ...
                      suffixIcon: TextButton(
                          onPressed: () {
                            ...
                            if (otpVerify(
                              ...
                              Get.snackbar("Wrong OTP", "Enter Correct OTP");
                            }
                          },
                          child: Container(
                            height: 25,
                            ...
                            child: Center(
                                child: customText("Verify OTP", 20,
                                    AppColors.primaryColor, FontWeight.normal)),
                          )),
                    ),
                  ),
                ...
                InkWell(
                  onTap: () async {
                    ...
                    if (_userController.otp && _userController.google) {
                      ...
                      Get.snackbar("Your Account not Created", "Try Again");
                    }
                  },
                  child: Container(
                    height: 30,
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: const BorderRadius.only(
                            ...
                            bottomRight: Radius.circular(20.0))),
                    child: Center(
                        child: customText("Create Account", 20,
                            AppColors.primaryColor, FontWeight.normal)),
                  ),
                ),
              ],
