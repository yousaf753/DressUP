      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              customText(
                  widget.productsModel.shoes![widget.index].name.toString(),
                  50,
                  AppColors.text1Color,
                  FontWeight.bold),
              customImage(
                  widget.productsModel.shoes![widget.index].image.toString(),
                  widget.height * 0.5,
                  widget.width),
              Padding(
                  ...
                  child: Column(
                    children: [
                      customText("Description", 20, AppColors.text1Color,
                          FontWeight.bold),
                      Text(
                        widget.productsModel.shoes![widget.index].description
                            .toString(),
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  customText(
                      "RS ${widget.productsModel.shoes![widget.index].price.toString()}",
                      30,
                    ...
                    onTap: () {
                      if (quantity >= 1) {
                        cartController.addItem(
                            widget.productsModel.shoes![widget.index].name
                                .toString(),
                            widget.productsModel.shoes![widget.index].image
                                .toString(),
                            double.parse(widget
                                .productsModel.shoes![widget.index].price
                                .toString()),
                            widget
                                .productsModel.shoes![widget.index].description
                                .toString(),
                            quantity);
                        Get.off(CartScreen(
