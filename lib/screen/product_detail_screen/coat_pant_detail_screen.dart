...
class CoatPantDetailScreen extends StatefulWidget {
  final double height, width;
  int index;
  ProductsModel productsModel = ProductsModel();

  CoatPantDetailScreen(
      {Key? key,
  ...
  @override
  _CoatPantDetailScreenState createState() => _CoatPantDetailScreenState();
}

class _CoatPantDetailScreenState extends State<CoatPantDetailScreen> {
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              customText(
                  widget.productsModel.coatpant![widget.index].name.toString(),
                  50,
                  AppColors.text1Color,
                  FontWeight.bold),
              customImage(
                  widget.productsModel.coatpant![widget.index].image.toString(),
                  widget.height * 0.5,
                  widget.width),
              Padding(
                  ...
                  child: Column(
                    children: [
                      customText("Description", 20, AppColors.text1Color,
                          FontWeight.bold),
                      Text(
                        widget.productsModel.coatpant![widget.index].description
                            .toString(),
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  customText(
                      "RS ${widget.productsModel.coatpant![widget.index].price.toString()}",
                      30,
                    ...
                    onTap: () {
                      if (quantity >= 1) {
                        cartController.addItem(
                            widget.productsModel.coatpant![widget.index].name
                                .toString(),
                            widget.productsModel.coatpant![widget.index].image
                                .toString(),
                            double.parse(widget
                                .productsModel.coatpant![widget.index].price
                                .toString()),
                            widget.productsModel.coatpant![widget.index]
                                .description
                                .toString(),
                            quantity);
                        Get.off(CartScreen(
