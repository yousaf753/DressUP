...
class WinterJacketDetailScreen extends StatefulWidget {
  final double height, width;
  int index;
  ProductsModel productsModel = ProductsModel();

  WinterJacketDetailScreen(
      {Key? key,
  ...
  @override
  _WinterJacketDetailScreenState createState() =>
      _WinterJacketDetailScreenState();
}

class _WinterJacketDetailScreenState extends State<WinterJacketDetailScreen> {
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              customText(
                  widget.productsModel.winterjacket![widget.index].name
                      .toString(),
                  50,
                  AppColors.text1Color,
                  FontWeight.bold),
              customImage(
                  widget.productsModel.winterjacket![widget.index].image
                      .toString(),
                  widget.height * 0.5,
                  widget.width),
              Padding(
                  ...
                  child: Column(
                    children: [
                      customText("Description", 20, AppColors.text1Color,
                          FontWeight.bold),
                      Text(
                        widget.productsModel.winterjacket![widget.index]
                            .description
                            .toString(),
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  customText(
                      "RS ${widget.productsModel.winterjacket![widget.index].price.toString()}",
                      30,
                    ...
                    onTap: () {
                      if (quantity >= 1) {
                        cartController.addItem(
                            widget
                                .productsModel.winterjacket![widget.index].name
                                .toString(),
                            widget
                                .productsModel.winterjacket![widget.index].image
                                .toString(),
                            double.parse(widget
                                .productsModel.winterjacket![widget.index].price
                                .toString()),
                            widget.productsModel.winterjacket![widget.index]
                                .description
                                .toString(),
