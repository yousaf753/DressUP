...
class SherwaniDetailScreen extends StatefulWidget {
  final double height, width;
  int index;
  ProductsModel productsModel = ProductsModel();

  SherwaniDetailScreen(
      {Key? key,
  ...
  @override
  _SherwaniDetailScreenState createState() => _SherwaniDetailScreenState();
}

class _SherwaniDetailScreenState extends State<SherwaniDetailScreen> {
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              customText(
                  widget.productsModel.sherwani![widget.index].name.toString(),
                  50,
                  AppColors.text1Color,
                  FontWeight.bold),
              customImage(
                  widget.productsModel.sherwani![widget.index].image.toString(),
                  widget.height * 0.5,
                  widget.width),
              Padding(
                  ...
                  child: Column(
                    children: [
                      customText("Description", 20, AppColors.text1Color,
                          FontWeight.bold),
                      Text(
                        widget.productsModel.sherwani![widget.index].description
                            .toString(),
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  customText(
                      "RS ${widget.productsModel.sherwani![widget.index].price.toString()}",
                      30,
                    ...
                    onTap: () {
                      if (quantity >= 1) {
                        cartController.addItem(
                            widget.productsModel.sherwani![widget.index].name
                                .toString(),
                            widget.productsModel.sherwani![widget.index].image
                                .toString(),
                            double.parse(widget
                                .productsModel.sherwani![widget.index].price
                                .toString()),
                            widget.productsModel.sherwani![widget.index]
                                .description
                                .toString(),
                            quantity);
                        Get.off(CartScreen(
