...
class WatchDetailScreen extends StatefulWidget {
  ...
  @override
  _WatchDetailScreenState createState() => _WatchDetailScreenState();
}
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              customText(
                  widget.productsModel.watch![widget.index].name.toString(),
                  50,
                  AppColors.text1Color,
                  FontWeight.bold),
              customImage(
                  widget.productsModel.watch![widget.index].image.toString(),
                  widget.height * 0.5,
                  widget.width),
              Padding(
                  ...
                  child: Column(
                    children: [
                      customText("Description", 20, AppColors.text1Color,
                          FontWeight.bold),
                      Text(
                        widget.productsModel.watch![widget.index].description
                            .toString(),
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  customText(
                      "RS ${widget.productsModel.watch![widget.index].price.toString()}",
                      30,
                    ...
                    onTap: () {
                      if (quantity >= 1) {
                        cartController.addItem(
                            widget.productsModel.watch![widget.index].name
                                .toString(),
                            widget.productsModel.watch![widget.index].image
                                .toString(),
                            double.parse(widget
                                .productsModel.watch![widget.index].price
                                .toString()),
                            widget
                                .productsModel.watch![widget.index].description
                                .toString(),
                            quantity);
                        Get.off(CartScreen(
