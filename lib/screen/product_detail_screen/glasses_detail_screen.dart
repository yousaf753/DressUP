...
class GlassesDetailScreen extends StatefulWidget {
  ...
  @override
  _GlassesDetailScreenState createState() => _GlassesDetailScreenState();
}

class _GlassesDetailScreenState extends State<GlassesDetailScreen> {
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              customText(
                  widget.productsModel.glasses![widget.index].name.toString(),
                  50,
                  AppColors.text1Color,
                  FontWeight.bold),
              customImage(
                  widget.productsModel.glasses![widget.index].image.toString(),
                  widget.height * 0.5,
                  widget.width),
              Padding(
                  ...
                  child: Column(
                    children: [
                      customText("Description", 20, AppColors.text1Color,
                          FontWeight.bold),
                      Text(
                        widget.productsModel.glasses![widget.index].description
                            .toString(),
                        style: TextStyle(
              ...
              Row(
                ...
                children: [
                  customText(
                      "RS ${widget.productsModel.glasses![widget.index].price.toString()}",
                      30,
                    ...
                    onTap: () {
                      if (quantity >= 1) {
                        cartController.addItem(
                            widget.productsModel.glasses![widget.index].name
                                .toString(),
                            widget.productsModel.glasses![widget.index].image
                                .toString(),
                            double.parse(widget
                                .productsModel.glasses![widget.index].price
                                .toString()),
                            widget.productsModel.glasses![widget.index]
                                .description
                                .toString(),
                            quantity);
                        Get.off(CartScreen(
